...
def process_weights_for_netuid(
    ...
    print("process_weights_for_netuid()")
    ...
    print("min_allowed_weights", min_allowed_weights)
    print("max_weight_limit", max_weight_limit)
    ...
    if non_zero_weights.size == 0 or metagraph.n < min_allowed_weights:
        print("No non-zero weights returning all ones.")
    ...
    print("exclude_quantile", exclude_quantile)
    print("lowest_quantile", lowest_quantile)

    # Exclude all weights below the allowed quantile.
    non_zero_weight_uids = non_zero_weight_uids[lowest_quantile <= non_zero_weights]
    non_zero_weights = non_zero_weights[lowest_quantile <= non_zero_weights]
    print("non_zero_weight_uids", non_zero_weight_uids)
    print("non_zero_weights", non_zero_weights)
    ...
    print("final_weights", normalized_weights)
